...
extension AudioSpectrogram: AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    public func captureOutput(_ output: AVCaptureOutput,
        ...
        //print("duration " + String(Float(CMSampleBufferGetDuration(sampleBuffer).value)))
        //print("timescale " + String(Float(CMSampleBufferGetDuration(sampleBuffer).timescale)))
        //print("numsamples " + String(Float(CMSampleBufferGetNumSamples(sampleBuffer))))
        //print("nyquist " + String(nyquistFrequency!))
